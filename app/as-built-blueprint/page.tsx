...
export const metadata: Metadata = { title: "工程竣工图与蓝图出图｜山江设计服务", description: "提供竣工图整理、会议纪要与变更对应、工程蓝图打印和出图文件整理。按资料、图幅、份数和交付要求人工评估。" };
...
export default function AsBuiltBlueprint() { return <main className="blueprintPage">
  ...
  <section className="blueprintHero"><div><p>AS-BUILT DRAWINGS · ENGINEERING BLUEPRINT</p><h1>把变更和纪要，<br /><em>落实到图纸里。</em></h1><span>竣工图整理与工程蓝图出图，均以你确认的文件和清单为依据。先核对资料、图号、图幅和交期，再开始整理或出图。</span><div><a href="#contact">提交图纸资料 →</a><a href="#services">查看两项服务</a></div></div><img src="/tekla/tekla-drawing.jpg" alt="工程图纸与蓝图出图资料" fetchPriority="high" decoding="async" /></section>
