...
export default function AsBuiltBlueprint() { return <main className="blueprintPage">
  ...
  <section className="blueprintPricing"><div><p>REFERENCE PRICE</p><h2>常规零售起步价，<br /><em>先把基础价写清。</em></h2><span>竣工图以实际修改量为准；工程蓝图按图幅单张计价。批量出图、运费、加急、特殊纸张与装订按实际要求另计。</span></div><div className="priceTables"><article><small>AS-BUILT DRAWINGS</small><h3>竣工图整理</h3><div><b>简单单页整理</b><strong>¥100 起 / 张</strong></div><div><b>多页或成套图纸</b><strong>先看资料报价</strong></div><p>适用于已提供原图、变更或经确认会议纪要的图纸修改与版本整理；复杂程度、缺失资料和加急需求会影响最终报价。</p></article><article><small>ENGINEERING BLUEPRINT</small><h3>工程蓝图出图</h3><div><b>A0</b><strong>¥10 / 张起</strong></div><div><b>A1</b><strong>¥5 / 张起</strong></div><div><b>A2</b><strong>¥3 / 张起</strong></div><div><b>A3</b><strong>¥1.5 / 张起</strong></div><p>按确认的 PDF、CAD 或其他可打印文件出图；50 张以上可按批量报价，折叠、装订、配送与加急请在提交时说明。</p></article></div></section>
