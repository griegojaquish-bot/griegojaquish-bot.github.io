...
export default function Home() { return <main className="portalHome">
  ...
  <section id="top" className="portalHero"><div className="portalHeroCopy"><p>DESIGN DETAILING · AI APPLICATIONS · AGI</p><h1>两类业务，<br /><em>走向 AGI 协同。</em></h1><span>山江设计与智能应用由“设计深化”和“AI 应用”两个独立板块组成。以工程交付与真实业务为起点，用更通用的 AI 能力连接信息、流程和人的决策。</span></div><div className="portalHeroVisual"><video autoPlay muted loop playsInline preload="metadata" poster="/agi-hero-poster-v1.webp" aria-label="AGI 智能核心连接业务流程、资料、工具与工程图纸的动态示意"><source media="(max-width: 850px)" src="/agi-hero-motion-mobile-v1.mp4" type="video/mp4" /><source src="/agi-hero-motion-v1.mp4" type="video/mp4" /></video><span>AGI</span><i>GENERAL INTELLIGENCE<br />FOR REAL WORK</i></div></section>
  ...
  <section id="method" className="portalMethod"><div><p>HOW TO START</p><h2>先选业务板块，<br /><em>再按实际范围评估。</em></h2></div><div><div className="portalSteps"><article><b>01</b><span>选择设计深化或 AI 应用</span></article><article><b>02</b><span>提交现有资料与目标</span></article><article><b>03</b><span>人工确认范围和报价</span></article></div><div className="portalWechat"><img src="/wechat-qr-v2.png" alt="山江设计与智能应用微信二维码，扫码添加微信" width="193" height="193" loading="eager" decoding="sync" /><div><small>WECHAT / 微信咨询</small><b>扫码添加微信</b><span>设计深化、AI 应用、网站或小程序需求均可直接沟通。</span></div></div></div></section>
