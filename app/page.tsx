...
export default function Home() { return <main className="portalHome">
  ...
  <section id="business" className="portalBusiness">
    ...
    <article className="businessCard aiPortal"><div className="businessImage"><picture><source media="(max-width: 850px)" srcSet="/portal-ai-mobile.webp" /><img src="/tekla/tekla-bridge-model.jpg" alt="AI 智能体、网站和小程序应用示意" loading="lazy" decoding="async" /></picture></div><div className="businessCopy"><small>PART 02 / AI APPLICATIONS</small><h2>AI 应用</h2><p>重点承接企业 AI 智能体与工作流落地，并提供网站建设、微信小程序开发及 AI 工程图文自动化。</p><ul><li>企业 AI 智能体与工作流</li><li>AI FDE 全行业协同</li><li>网站建设与微信小程序</li><li>AI 工程图文与资料自动化</li></ul><a href="/ai-applications">进入 AI 应用板块 <b>→</b></a></div></article>
  </section>
