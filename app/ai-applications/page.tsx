...
export default function AiApplications() { return <main className="aiApplications">
  <header className="portalNav dark"><a className="portalBrand" href="/"><b>SJ</b><span>山江 AI 应用<small>AI APPLICATIONS</small></span></a><nav><a href="/">三大业务</a><a href="#applications">服务内容</a><a href="#process">实施流程</a><a className="portalNavCta" href="#contact">提交任务 →</a></nav></header>
  ...
  <aside className="aiMobileQuick"><a href="/">三大业务</a><a href="#applications">服务内容</a><a href="#contact">提交任务</a></aside>
