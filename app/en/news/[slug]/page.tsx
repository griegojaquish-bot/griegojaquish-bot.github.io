...
export default async function EnglishArticlePage({params}:{params:Promise<{slug:string}>}){
  ...
  return <main className="article enArticle">
    <header className="detailTop"><Link className="brand" href="/en"><b>ZY</b><span>SHANJIANG<small>MODULAR HOUSING</small></span></Link><div><Link href="/en/news">Back to news</Link><a className="detailCta" href="/en/#contact">Get a quote →</a></div></header>
