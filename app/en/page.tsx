...
export default function EnglishHome() {
  return <main>
    ...
    <nav className="nav" aria-label="Main navigation"><Link className="brand" href="/en"><b>ZY</b><span>SHANJIANG<small>MODULAR HOUSING</small></span></Link><div className="navLinks"><a href="#products">Products</a><Link href="/en/factory">Factory &amp; Projects</Link><Link href="/tekla-steel-detailing">Tekla Detailing</Link><Link href="/tekla-steel-detailing-cn">中文 Tekla</Link><Link href="/en/news">News</Link><a href="#contact">Contact</a><Link href="/">中文</Link><a className="navCta" href="#contact">Get a Quote <i>→</i></a></div></nav>
    ...
    <footer><Link className="brand" href="/en"><b>ZY</b><span>SHANJIANG<small>MODULAR HOUSING</small></span></Link><p>Taiping, Conghua, Guangzhou, Guangdong, China<br/>+86 135 3995 7289 · 13120056@qq.com</p><small>© 2026 SHANJIANG STEEL STRUCTURE. ALL RIGHTS RESERVED.</small></footer>
  </main>;
}
