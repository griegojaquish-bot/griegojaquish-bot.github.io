...
export default function FactoryProofPage() {
  return <main className="factoryProof">
    ...
    <header className="factoryNav"><Link className="brand" href="/en"><b>ZY</b><span>SHANJIANG<small>MODULAR HOUSING</small></span></Link><div><Link href="/en#products">Products</Link><a href="/en#contact">Get a Quote →</a></div></header>
    ...
    <footer><Link className="brand" href="/en"><b>ZY</b><span>SHANJIANG<small>MODULAR HOUSING</small></span></Link><p>Taiping, Conghua, Guangzhou, Guangdong, China<br/>+86 135 3995 7289 · 13120056@qq.com</p></footer>
  </main>;
}
