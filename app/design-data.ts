...
export const designCases: DesignCase[] = [
  ...
  { slug: "mountain-valley-camp", image: "/project-mountain-valley-camp.jpg", title: "山谷营地空间", tag: "项目空间参考", summary: "用于展示自然场地中的营地单元、公共活动空间与整体氛围的组织方向。", focus: ["场地关系", "营地单元", "公共活动空间"] },
];
